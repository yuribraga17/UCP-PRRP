...
<body class="fixed-header">
	<header>
		<div class="container">
			...
			<a href="/?page=login" class="logo"><img src="assets/img/XXXXXX.png" height="40" width="40"></a>
			
			<nav>
				<div class="nav-control">
					<ul>
						<li><a href="LINK" target="_blank">Fórum</a></li>
						<li><a href="LINK" target="_blank">Downloads</a></li>
						<li><a href="LINK" target="_blank">Staff</a></li>
						<li><a href="LINK" target="_blank">VAGO1</a></li>
						<li><a href="LINK" target="_blank">VAGO2</a></li>
						<li><a href="LINK" target="_blank">VAGO3</a></li>
					</ul>
				</div>
			</nav>
		</div>
