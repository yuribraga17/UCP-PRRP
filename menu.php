...
<!-- ÁREA DE ADMINISTRADORES-->
 ...
 <?php } ?>
  ...
  <?php if($pAdmin > 5){ 
	...
	if($link == '/ucp/apps') echo '<li class="active">'; else echo "<li>"; 
 ?>
	<a href="<?=$url_base;?>/log4"><i class="fa fa-cog"></i><i class="fa  fa-sort-alpha-down"></i> <span class="nav-label">Log armas</span></a>
	<a href="<?=$url_base;?>/log"><i class="fa fa-cog"></i><i class="fa  fa-sort-alpha-down"></i> <span class="nav-label">Refundo arma</span></a>
	<a href="<?=$url_base;?>/log2"><i class="fa fa-cog"></i><i class="fa  fa-sort-alpha-down"></i> <span class="nav-label">Refundo dinheiro</span></a>
	<a href="<?=$url_base;?>/log3"><i class="fa fa-cog"></i><i class="fa  fa-sort-alpha-down"></i> <span class="nav-label">Refundo itens</span></a></li>
...
<?php 
	...
	echo '
			<a href="#"><i class="fa fa-flag"></i> <span class="nav-label">Area policial</span><span class="fa arrow"></span></a>
			<ul class="nav nav-second-level collapse">';
	if($link == 'www.google.com') echo '<li class="active">'; else echo "<li>"; 
?>
	<a href="<?=$url_base;?>/190"><i class="fa fa-cog"></i><i class="fa  fa-angle-right"></i> <span class="nav-label">registro 190</span></a>
	<a href="<?=$url_base;?>/criminal"><i class="fa fa-cog"></i><i class="fa  fa-angle-right"></i> <span class="nav-label">Fichas Criminais</span></a>
	</ul></li></li>
</li>
<!-- Start Footer Section -->
